  ...
  <div class="bg-white rounded-[2rem] border border-slate-100 p-8 md:p-10 animate-scale-in max-w-md mx-auto shadow-sm">
    ...
    <form @submit.prevent="handleLogin" class="space-y-4">
      ...
      <div>
        ...
        <input v-model="password" type="password" required minlength="8" title="Password must be at least 8 characters long" class="input-field" placeholder="••••••••" />
      </div>
    ...
    <p class="text-center text-sm text-slate-500 mt-6">
      Don't have a vendor account? <NuxtLink to="/auth/register" class="text-primary-800 font-semibold hover:underline">Sign up</NuxtLink>
    </p>
  </div>
</template>
