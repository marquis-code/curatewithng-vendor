import { defineComponent, ref, unref, useSSRContext } from 'file:///Users/marquis/curatewithng/vendor/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderList, ssrRenderAttr, ssrInterpolate, ssrRenderClass } from 'file:///Users/marquis/curatewithng/vendor/node_modules/vue/server-renderer/index.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(loading)) {
        ...
        _push(`<tr class="border-b border-slate-100 bg-white"><td colspan="5" class="p-12 text-center text-slate-500"><div class="text-4xl mb-3">\u{1F381}</div><p>You haven&#39;t added any gifts yet</p><button class="btn-secondary mt-4">Add Your First Gift</button></td></tr>`);
      } else {
        _push(`<!--[-->`);
...
//# sourceMappingURL=index-BTMwu7pR.mjs.map
