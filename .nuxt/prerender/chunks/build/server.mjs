import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, getCurrentInstance, defineComponent, createElementBlock, shallowRef, provide, cloneVNode, h, defineAsyncComponent, inject, computed, unref, shallowReactive, ref, Suspense, Fragment, createApp, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, mergeProps, getCurrentScope, toRef, withCtx, nextTick, isReadonly, useSSRContext, isRef, isShallow, isReactive, toRaw, markRaw } from 'file:///Users/marquis/curatewithng/vendor/node_modules/vue/index.mjs';
import { $fetch } from 'file:///Users/marquis/curatewithng/vendor/node_modules/ofetch/dist/node.mjs';
...
import { getContext, executeAsync } from 'file:///Users/marquis/curatewithng/vendor/node_modules/unctx/dist/index.mjs';
import { sanitizeStatusCode, createError as createError$1, appendHeader } from 'file:///Users/marquis/curatewithng/vendor/node_modules/h3/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///Users/marquis/curatewithng/vendor/node_modules/vue-router/vue-router.node.mjs';
import { defu } from 'file:///Users/marquis/curatewithng/vendor/node_modules/defu/dist/defu.mjs';
import { parseURL, encodePath, decodePath, hasProtocol, isScriptProtocol, joinURL, withQuery } from 'file:///Users/marquis/curatewithng/vendor/node_modules/ufo/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file:///Users/marquis/curatewithng/vendor/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    ...
    component: () => import('./index-DXiURa8f.mjs')
  },
  {
    name: "auth-login",
    path: "/auth/login",
    meta: __nuxt_page_meta$2 || {},
    component: () => import('./login-Da_4_qK_.mjs')
  },
  {
    name: "gifts",
    path: "/gifts",
    meta: { "middleware": "auth" },
    component: () => import('./index-BTMwu7pR.mjs')
  },
  {
    name: "orders",
    path: "/orders",
    meta: { "middleware": "auth" },
    component: () => import('./index-CFvdoQjs.mjs')
  },
  {
    name: "auth-register",
    path: "/auth/register",
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./register-DSwQ-3rH.mjs')
  },
  {
    name: "settings",
    path: "/settings",
    meta: { "middleware": "auth" },
    component: () => import('./index-CD7P4by1.mjs')
  },
  {
    name: "dashboard",
    path: "/dashboard",
    meta: { "middleware": "auth" },
    component: () => import('./index-NOlchHUj.mjs')
  },
  {
    name: "auth-forgot-password",
    path: "/auth/forgot-password",
    meta: __nuxt_page_meta || {},
    component: () => import('./forgot-password-G_Knyp1H.mjs')
  }
];
...
const layouts = {
  auth: defineAsyncComponent(() => import('./auth-DZsf_-rY.mjs').then((m) => m.default || m)),
  default: defineAsyncComponent(() => import('./default-BNWH0xd1.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DsIBhRPm.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-braxEAZ2.mjs'));
...
export { _export_sfc as _, useNuxtApp as a, useRequestEvent as b, useRouter as c, defineNuxtRouteMiddleware as d, entry_default as default, encodeRoutePath as e, nuxtLinkDefaults as f, navigateTo as n, resolveRouteObject as r, tryUseNuxtApp as t, useRuntimeConfig as u };
